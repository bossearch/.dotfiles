-- TODO: fix keymaps setting for telescope
return {
  ...
  config = function()
      ...
      defaults = {
        ...
        mappings = {
          i = {
            ...
            ["<C-T>"] = actions.send_selected_to_qflist + custom_actions.open_trouble_qflist,
    ...
    vim.keymap.set("n", "<space>fb", "<cmd>Telescope buffers<cr>", { desc = "Find available buffers" })
  end,
}
