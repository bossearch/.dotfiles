{
  ...
  home.file.".mozilla/firefox/bosse/extensions/bukubrow@samhh.com.xpi" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.dotfiles/configs/buku/bukubrow@samhh.com.xpi";
  };
}
