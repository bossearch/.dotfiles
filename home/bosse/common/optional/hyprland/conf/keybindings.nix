{...}: {
  wayland.windowManager.hyprland.extraConfig = ''
    ...
    $drun = kitty -T fzf -o cursor_trail=0 sh -c "~/.config/fzf/extra/drun.sh"
    $run = kitty -T fzf -o cursor_trail=0 sh -c "~/.config/fzf/extra/run.sh"
    $emoji = kitty -T fzf -o cursor_trail=0 sh -c "~/.config/fzf/extra/emoji.sh; kitty @ close-window"
    $clipboard = kitty -T fzf -o cursor_trail=0 sh -c "~/.config/fzf/extra/clipboard.sh; kitty @ close-window"
